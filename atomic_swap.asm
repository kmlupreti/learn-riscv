; atomically exchanges value between register and memory
...
sc.w x4, x22, (x20)
; do not continue the swap and try again if the store was unsucessful
bne x4, x0, ATOMIC_SWAP
; copy the value loaded from memory into register x22
addi x22, x5, x0

; if the processer context switches or intervenes and modifies value in memory between operations
